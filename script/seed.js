...
async function seed() {
  ...
  await Promise.all([
    ...
    Media.create({ path: 'https://cdn.vox-cdn.com/thumbor/sGSzFCg3HO3kSxn0Pw-4StZ4XhE=/0x0:750x939/1820x1213/filters:focal(234x192:354x312):format(webp)/cdn.vox-cdn.com/uploads/chorus_image/image/62648422/Dt2jm_aVAAAiTrz.0.jpg', x_coord: 65, y_coord: 65, tilt: 0, size: 20, filter: 2, pageId: 1 }),
    Media.create({ path: 'https://cdn1.thr.com/sites/default/files/imagecache/1500x845/2017/11/larry2_-_h_2017.jpg', x_coord: 70, y_coord: 70, tilt: 0, size: 20, filter: 2, pageId: 1 }),
    Media.create({ path: 'https://cdn1.thr.com/sites/default/files/imagecache/1500x845/2017/11/larry2_-_h_2017.jpg', x_coord: 75, y_coord: 65, tilt: 0, size: 20, filter: 2, pageId: 2 }),
    Media.create({ path: 'https://cdn.vox-cdn.com/thumbor/sGSzFCg3HO3kSxn0Pw-4StZ4XhE=/0x0:750x939/1820x1213/filters:focal(234x192:354x312):format(webp)/cdn.vox-cdn.com/uploads/chorus_image/image/62648422/Dt2jm_aVAAAiTrz.0.jpg', x_coord: 75, y_coord: 60, tilt: 0, size: 20, filter: 2, pageId: 2 }),
    Media.create({ path: 'https://www.youtube.com/watch?v=tHbCkikFfDE', x_coord: 65, y_coord: 65, tilt: 0, size: 20, filter: 2, pageId: 1 }),
    Media.create({ path: 'https://www.youtube.com/watch?v=tHbCkikFfDEnpm', x_coord: 65, y_coord: 65, tilt: 0, size: 20, filter: 2, pageId: 1 }),
